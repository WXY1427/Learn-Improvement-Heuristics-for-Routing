...
def get_options(args=None):
    ...
    parser.add_argument('--batch_size', type=int, default=384, help='Number of instances per batch during training') #####512
    parser.add_argument('--epoch_size', type=int, default=3840, help='Number of instances per epoch during training')  #1280000
    ...
    parser.add_argument('--steps', type=int, default=100, help='Number of steps to swap')
    ...
    #####default='outputs/cvrp_50/run/epoch-63.pt', 
